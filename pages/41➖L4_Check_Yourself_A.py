...
st.set_page_config(page_title="Check Yourself: [æ]", page_icon="🎱", layout="centered")

# --- 2. PDF Generation Logic (Optimized Header) ---
class PDF(FPDF):
    def header(self):
        self.set_fill_color(51, 102, 153) # Navy Blue
        self.rect(0, 0, 210, 20, 'F') # Fixed vertical height (20mm)
...
def create_pdf(name, score, total, results, start_t, end_t):
    ...
    pdf = PDF()
    pdf.set_top_margin(30) # Ensures text starts below the blue header
    pdf.add_page()
